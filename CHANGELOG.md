...
### Refactored
- **Directory Structure Cleanup**: Reorganized project root by moving reports, scripts, and tests into dedicated subdirectories (`.kiro/specs/`, `scripts/`, `tests/`, `certs/`).
- **Improved Maintainability**: Separated documentation and build artifacts from source code.

### Fixed
- **Build Scripts**: Updated build process to respect new directory layout.
